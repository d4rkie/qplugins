...
Name "WavPack Decoder Plug-in"
; The file to write
OutFile "in_WavPack.exe"
...
Section "Main"
  ...
  ; Put file there
  ${If} $QIsQMP == "True"
    File "/oname=QMPWV.dll" "Release\QMPWV.dll"
  ${Else}
    File "/oname=QCDWV.dll" "Release\QMPWV.dll"
  ${Endif}

  MessageBox MB_OK "Install Finished! $\r$\nNote: WavPack support APE v2 tag format. $\r$\nPlease add $\"WV$\" to APE v2 tag plug-in's type-list manully."
