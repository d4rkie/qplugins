...
#ifndef __TAK_DECO_LIB
#define __TAK_DECO_LIB
...
enum tak_Preset {
  ...
  tak_Preset_High   = 3,
  tak_Preset_Extra  = 4,
  tak_Preset_First  = tak_Preset_Turbo,
  tak_Preset_Last   = tak_Preset_Extra,
  tak_Preset_Num    = tak_Preset_Last - tak_Preset_First + 1,
};
