...
#define ITEM_EDIT_MARGIN			0

//////////////////////////////////////////////////////////////////////////

class CTreeEdit : 
	public CWindowImpl< CTreeEdit, CEdit >
{
public:
	CTreeEdit() {}
	~CTreeEdit() {}
...
class CTreeCtrl : 
	public CWindowImpl< CTreeCtrl, CTreeViewCtrlEx >, 
...
public:
	...
	{
		return CWindowImpl< CTreeCtrl, CTreeViewCtrlEx >::SubclassWindow( hWnd) ? Initialise() : FALSE;
	}
	...
	BOOL SelectItem(HTREEITEM hItem)
	{
		...
		return CWindowImpl< CTreeCtrl, CTreeViewCtrlEx >::SelectItem( hItem);
	}
	...
	void GetSelectedItems(CSimpleArray < HTREEITEM >& aSelectedItems)
	{
		...
		else // get all selected tree items (recursive)
