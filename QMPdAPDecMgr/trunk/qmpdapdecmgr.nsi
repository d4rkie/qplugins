...
Name "dBpowerAMP Decoder Manager Plug-in"
; The file to write
OutFile "in_dAPMgr.exe"
...
Section "Main"
  ...
  ; Put file there
  ${If} $QIsQMP == "True"
    File "/oname=QMPdAPDecMgr.dll" "Release\QMPdAPDecMgr.dll"
  ${Else}
    File "/oname=QCDdAPDecMgr.dll" "Release\QMPdAPDecMgr.dll"
  ${Endif}

  MessageBox MB_OK "Install Finished! $\r$\nTips: Please download dBpowerAMP's decoder plug-in from its website manully."
